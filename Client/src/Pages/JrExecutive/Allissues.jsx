...
const AllIssues = () => {
    ...
    const applyFilters = () => {
        ...
        let list = issues.filter(issue => {
            ...
            const matchesStatus =
                filterStatus === 'all' ||
                issue.jrExecutiveStatus?.status === filterStatus;
    ...
    const pendingCount = issues.filter(i => i.jrExecutiveStatus.status === 'Pending').length;
    const approvedCount = issues.filter(i => i.jrExecutiveStatus.status === 'Approved').length;
                                ...
                                <tbody>
                                    {filteredIssues.map(issue => (
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-4">
                                                {getStatusBadge(issue.jrExecutiveStatus.status)}
                                            </td>
