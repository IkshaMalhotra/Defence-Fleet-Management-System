        ...
        <div className="card p-6">
          ...
          {filteredVehicles.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-military-400">No vehicles found</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredVehicles.map((vehicle) => (
                <div
                  key={vehicle._id}
                  className="card card-hover p-6 space-y-3"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-military-100">
                          {vehicle.name}
                        </h3>
                        <span className={`inline-block mt-1 px-2 py-0.5 rounded text-xs font-semibold border ${getClassColor(vehicle.vehicleClass)}`}>
